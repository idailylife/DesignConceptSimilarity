...
def pre_processing(sentence, stem=True):
    ...
    sentence = re.sub(pattern, "", sentence)
    sentence = re.sub('['+string.punctuation+']', '', sentence).lower()
...
if __name__ == '__main__':
    ...
    tfIdfHelper = TfIdfHelper(pre_processing, document_file_path=filein)
    response_dict = tfIdfHelper.get_non_zero_tfidf(str)
    print response_dict